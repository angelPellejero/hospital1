...
use Angel\HospitalBundle\Entity\Paciente;
...
class PacienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pacientes = $em->getRepository('AngelHospitalBundle:Paciente')->findAll();
...
//    public function solicitarCitaAction(){
//        $cita = new Cita();
//        return $this->redirectToRoute('cita_new');
//    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Angel\HospitalBundle\Form\PacienteType', $paciente);
    ...
    {
        $deleteForm = $this->createDeleteForm($paciente);
        $editForm = $this->createForm('Angel\HospitalBundle\Form\PacienteType', $paciente);
